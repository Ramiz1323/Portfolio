  ...
  return (
    <div className="pt-24 pb-16 min-h-screen grid-bg">
      <div className="container mx-auto px-4">
        <h1 className="text-4xl font-bold mb-8 gaming-gradient text-center fade-in">Contact Me</h1>
              ...
              <CardContent className="p-6">
                ...
                <div className="space-y-6">
                  <div className="flex items-start slide-up" style={{ animationDelay: "0.3s" }}>
                    <div className="mr-4 p-3 bg-muted/10 rounded-full">
                ...
                <div className="mt-8 slide-up" style={{ animationDelay: "0.6s" }}>
